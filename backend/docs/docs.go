    ...
    "paths": {
        ...
        "/encode": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Post IDs and batch size for encoding",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/server.encodePostsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.encodePostsResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request body",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/analogdb.CreatePost"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/analogdb.PatchPost"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.PatchResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request body",
        ...
        "/posts": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Filter by focal length",
                        "name": "focal_length",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by aperture",
                        "name": "aperture",
                        "in": "query"
                    },
                    {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.StatsCamerasResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid query parameters",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.StatsColorsResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid query parameters",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.StatsFilmsResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid query parameters",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.StatsOverviewResponse"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.StatsPeriodsResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid query parameters",
    ...
    "definitions": {
        ...
        "analogdb.CreatePost": {
            ...
            "properties": {
                ...
                "keywords": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/analogdb.Keyword"
                    }
                },
                "nsfw": {
                    "type": "boolean",
        ...
        "analogdb.Image": {
            ...
            "properties": {
                ...
                "url": {
                    "type": "string",
                    "example": "https://cloudfront.net/1.jpeg"
                },
                "width": {
                    "type": "integer",
                    "example": 4800
        ...
        "server.PatchResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string",
                    "example": "Success, post patched"
                }
            }
        },
        "server.PostResponse": {
        ...
        "server.StatsCamerasResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/analogdb.StatsCamera"
                    }
                },
                "meta": {
                    "$ref": "#/definitions/analogdb.StatsMeta"
                }
            }
        },
        "server.StatsColorsResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/analogdb.StatsColor"
                    }
                },
                "meta": {
                    "$ref": "#/definitions/analogdb.StatsMeta"
        ...
        "server.StatsFilmsResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/analogdb.StatsFilm"
                    }
                },
                "meta": {
                    "$ref": "#/definitions/analogdb.StatsMeta"
        ...
        "server.StatsOverviewResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/analogdb.StatsOverview"
                },
                "generated_at": {
                    "type": "string"
                }
        ...
        "server.StatsPeriodsResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/analogdb.StatsPeriod"
                    }
                },
                "meta": {
                    "$ref": "#/definitions/analogdb.StatsMeta"
